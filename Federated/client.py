...
from augment import no_augmentation  # Import other augmentation functions as needed
...
selected_augmentation = no_augmentation  # Replace with any other function as needed
